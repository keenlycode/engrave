...
Opinionated documentation for Engrave, a lightweight static-site generator built on Python and Jinja2. Use these guides to get a site rendering quickly, then lean on the CLI reference when you need copy/exclude/watch control or live preview.

## Where to go
- [Quickstart](quickstart.md): build a minimal site and understand the directory layout Engrave expects.
- [CLI Reference](cli.md): arguments for `engrave build` and `engrave server`, plus copy/exclude/watch notes.
